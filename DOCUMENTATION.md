...
## Overview
Maintenance Panel is a React-based web application for tracking daily jobs, expenses, and managing teams. It uses Supabase for authentication and database services.
...
2. **Landing Page**: Visit the root URL `/`. You should see the "Maintenance Panel" landing page with a "Comenzar Gratis" button.
